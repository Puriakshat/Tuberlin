 ...
 */
public class QueuePanel extends java.awt.Panel implements java.awt.event.ActionListener {
	...
	if (controller != null) {
            controller._actionDetailsButtonPressed("queue");
	}
    }
    /**
    ...
    /**
     * connEtoC1:  (DetailsButton.action.actionPerformed(java.awt.event.ActionEvent) --> QueuePanel._actionDetailsButtonPressed()V)
	...
	try {
            ...
            QueuePanel aQueuePanel;
            aQueuePanel = new QueuePanel();
            frame.add("Center", aQueuePanel);
            frame.setSize(aQueuePanel.getSize());
